...
public class HotelService {
	...
	public synchronized List<Hotel> findAll(String strFilterName, String strFilterAdress) {
		ArrayList<Hotel> arrayList = new ArrayList<>();
		for (Hotel hotel : hotels.values()) {
			try {
				
				boolean passesName = (strFilterName == null || strFilterName.isEmpty())	|| hotel.getName().toLowerCase().contains(strFilterName.toLowerCase());
				boolean passesAdress = (strFilterAdress == null || strFilterAdress.isEmpty()) || hotel.getAddress().toLowerCase().contains(strFilterAdress.toLowerCase());
				if (passesName && passesAdress) {
